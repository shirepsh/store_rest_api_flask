...
Milk_pro3 = Milk_products(name="yogurt", price="3.90", Description="Vanilla flavored cheese delicacy 3% 125 grams")
...
Fish2 = Fishes(name="bream", price="89.90", Description="Fresh whole bream price for 1 kg")
Fish3 = Fishes(name="leek", price="69.90", Description="For fresh whole leek, price per 1 kg")
Fish4 =Fishes(name="spices", price="14.90", Description="Set of spices for cooking fish at home")
